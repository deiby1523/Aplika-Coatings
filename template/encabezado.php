...
<header>
        <nav class="menu">
            ...
            <ul><!---------------------------------->
                ...
                <li><a class="underline" <?php if($Pagina == $Productos) { echo ("style='color: #F28E2A;'"); } ?> href="producto.php?pag_actual=Productos" ><i class="fa-solid fa-angle-down"></i>&nbspSistemas</a>
